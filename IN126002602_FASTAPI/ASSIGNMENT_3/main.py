...
def get_products_audit():
    ...
    if products:
        ...
        most_expensive={
            "name": raw_expensive['name'], 
            "price": raw_expensive['price']
        }
    else:
        most_expensive = None
    return {
...
def apply_category_discount(
    ...
    for product in products:
        if product['category'].lower()==category.lower():
            ...
            product['price']=int(product['price'] * discount_multiplier)
    ...
    if not updated_products:
        return {"message": f"No products found in category '{category}' to update."}
    return {
        "message": f"Successfully applied {discount_percent}% discount to {category}.",
        "count": len(updated_products),
        "updated_items": updated_products
    }
